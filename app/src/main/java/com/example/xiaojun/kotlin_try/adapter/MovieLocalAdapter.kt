 ...
 * Version 1.0.0
 */
class MovieLocalAdapter(private val mData:List<HashMap<String,Any>>):RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder?, position: Int) {
        ...
        Glide.with(App.getContext())
                .load(mData[position]["thumb"])
                .bitmapTransform(RoundedCornersTransformation(App.getContext(),20,0))
